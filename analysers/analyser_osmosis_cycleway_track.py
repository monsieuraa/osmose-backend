...
class Analyser_Osmosis_Cycleway_track(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs[1] = {"item":"1180", "level": 2, "tag": ["geom", "highway", "cycleway", "cycle", "fix:chair"], "desc": T_(u"Duplicated cycle tracks, highway=*+cycleway=track and highway=cycleway") }
